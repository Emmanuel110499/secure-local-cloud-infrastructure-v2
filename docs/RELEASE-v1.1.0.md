...
![Évolution de l'architecture entre v1.0 et v1.1](diagrams/evolution-v1.0-v1.1.svg)
...
![Architecture de production Secure Local Cloud v1.1](diagrams/architecture-production-v1.1.svg)
...
![Supervision du PC Windows via Tailscale](screenshots/v1.1-monitoring-pc-emmanuel.png)

### VM srv-web

![Supervision de la VM srv-web](screenshots/v1.1-monitoring-vm-srv-web.png)

### VM srv-monitoring

![Supervision de la VM srv-monitoring](screenshots/v1.1-monitoring-vm-srv-monitoring.png)
